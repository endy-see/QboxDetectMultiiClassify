    ...
    def train_model(self, sess, max_iters):
        ...
        while iter < max_iters + 1:
            ...
            if now - last_summary_time > cfg.TRAIN.SUMMARY_INTERVAL:
                ...
                rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss_rbox, loss_quadbox, loss_confidence, total_loss, summary = \
                ...
                rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss_rbox, loss_quadbox, loss_confidence, total_loss = \
