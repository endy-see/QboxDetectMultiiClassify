...
class resnetv1(Network):
  ...
  def _build_network(self, sess, is_training=True, is_export=False):
    ...
    with tf.variable_scope(self._resnet_scope, self._resnet_scope):
      ...
      cls_prob, bbox_pred, rbox_pred, quadbox_pred, recogn_pred \
       = self._region_classification(fc7, is_training, 
                                    initializer, initializer_bbox)

    self._score_summaries.update(self._predictions)

    return rois, cls_prob, bbox_pred, rbox_pred, quadbox_pred, recogn_pred
